...
const Menu = (props) => {
  const { useStore, menu, MenuTop, MenuBottom, menuStyle, Link, inputPath, asideStyle } = props;
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("aside", { className: "frame-aside", style: asideStyle, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: "menu", ref: menuRef, style: { ...menuStyle, height: "100%" }, children: [
