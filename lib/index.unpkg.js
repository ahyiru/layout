...
const tree_excluded = ["item"],
  tree_excluded2 = ["data", "collapsed", "type", "Link", "width", "bgColor", "itemHeight", "collapsedWidth", "itemPadding", "style", "className"],
  _excluded3 = ["float"],
  _excluded4 = ["item"];
...
const getList = (isNormal, float) => isNormal ? _ref => {
  let {
    ...
    rest = _objectWithoutProperties(_ref, tree_excluded);
...
const Index = props => {
  ...
  const {
    ...
    rest = _objectWithoutProperties(props, tree_excluded2);
  const timer = (0,external_root_React_commonjs_react_commonjs2_react_amd_react_.useRef)();
  ...
  const _ref2 = (_rest$style = rest == null ? void 0 : rest.style) != null ? _rest$style : {},
    ...
    restStyle = _objectWithoutProperties(_ref2, _excluded3);
...
const frame_Index = props => {
  ...
  const memoHeader = (0,external_root_React_commonjs_react_commonjs2_react_amd_react_.useMemo)(() => /*#__PURE__*/(0,jsx_runtime.jsx)(huxy_layout_header, frame_objectSpread({}, props)), [language]);
  const {
    width
  } = use_useWinResize();
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("header", {
      ...
      style: headerStyle,
      children: [memoHeader, navMenu != null && navMenu.length ? /*#__PURE__*/(0,jsx_runtime.jsx)(huxy_components_tree, {
        data: navMenu,
        type: "horizontal",
        Link: Link,
        style: navMenuStyle
