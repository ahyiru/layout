...
const DELAY = 450;
const Views = (props) => {
  const { inputPath, contentStyle, children } = props;
  const prevPathRef = (0,external_root_React_commonjs_react_commonjs2_react_amd_react_.useRef)(inputPath);
  const timer = (0,external_root_React_commonjs_react_commonjs2_react_amd_react_.useRef)();
  const [aniCls, setAniCls] = (0,external_root_React_commonjs_react_commonjs2_react_amd_react_.useState)("");
  (0,external_root_React_commonjs_react_commonjs2_react_amd_react_.useEffect)(() => {
    if (inputPath !== prevPathRef.current) {
...
const Main = (props) => {
  const { menu, current, MainTop } = props;
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: `frame-container${hasMenu ? "" : " no-sidebar"}`, children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "frame-view", children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: "page-container", children: [
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Views, { ...props })
    ] }) }),
...
const Frame = (props) => {
  ...
  const composeCollapsed = isCompose && collapsed ? "composeCollapsed" : "";
  const classes = ["frame", menuCls, composeCollapsed].filter(Boolean).join(" ");
