...
var header_update = injectStylesIntoStyleTag_default()(layout_header/* default */.Z, header_options);
       ...
       /* harmony default export */ var huxy_layout_header = (layout_header/* default */.Z && layout_header/* default.locals */.Z.locals ? layout_header/* default.locals */.Z.locals : undefined);
...
const MemoHeader = ({ language, ...rest }) => (0,external_root_React_commonjs_react_commonjs2_react_amd_react_.useMemo)(() => /* @__PURE__ */ (0,jsx_runtime.jsx)(header, { ...rest }), [language]);
const FrameHeader = (props) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("header", { className: "frame-header", style: headerStyle, children: [
    (leftList == null ? void 0 : leftList.length) || (rightList == null ? void 0 : rightList.length) ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
      MemoHeader,
      {
        Link,
        leftList,
...
/* harmony default export */ var huxy_layout_header_0 = (FrameHeader);
...
const useAniCls = ({ inputPath, menuAnimate = "ani-in" }) => {
  const prevPathRef = (0,external_root_React_commonjs_react_commonjs2_react_amd_react_.useRef)(inputPath.split("?")[0]);
  const timer = (0,external_root_React_commonjs_react_commonjs2_react_amd_react_.useRef)();
...
const Frame = (props) => {
  ...
  const isSide = sideMenu == null ? void 0 : sideMenu.length;
  const isNav = navMenu == null ? void 0 : navMenu.length;
  ...
  const noHeaderCls = (leftList == null ? void 0 : leftList.length) || (rightList == null ? void 0 : rightList.length) ? "" : "no-header";
