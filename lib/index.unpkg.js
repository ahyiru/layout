...
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* reexport */ huxy_layout_frame_0)
});
...
const ItemEl = ({ img, name, icon, Ricon, open }) => img ? /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: "avatar", children: [
  /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "img", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(base64Image, { src: img, width: "1", height: "1", crossOrigin: "anonymous", alt: "avatar" }) }),
...
const NavItem = ({ item, click }) => {
  ...
  const { arrowDir, ChildRender, children, smShow, ulStyle } = item;
  ...
  const smCls = smShow ? "sm-show" : "";
  return hasChildren || ChildRender ? /* @__PURE__ */ (0,jsx_runtime.jsxs)("li", { ref: navRef, className: `${smCls} ${open ? "open" : ""}`, onClick: (e) => itemClick(e, item, false), children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(ItemWrap, { item, open }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("ul", { className: `huxy-header-arrow-${arrowDir || "rt"}`, style: ulStyle, children: hasChildren ? children.map((v, k) => /* @__PURE__ */ (0,jsx_runtime.jsx)("li", { className: v.divider ? "divider" : "", children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("span", { onClick: (e) => itemClick(e, v, true), className: `link${v.active ? " active" : ""}`, children: [
    ...
    ] }) }, `subItem-${k}-${v.key || v.name}`)) : /* @__PURE__ */ (0,jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ChildRender, { item, close: () => setOpen(false) }) }) })
  ] }) : /* @__PURE__ */ (0,jsx_runtime.jsx)("li", { onClick: (e) => itemClick(e, item), className: smCls, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ItemWrap, { item, open }) });
};
...
/* harmony default export */ const navList = (NavList);

;// CONCATENATED MODULE: ../huxy/layout/header/header.jsx
...
const Header = (props) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: "header", children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(Link, { className: "banner", to: "/", children: [
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "title", children: title ?? "Dashboard" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "nav", children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: "nav-wrap", children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "nav-left", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(navList, { list: leftList, click: handleNavClick }) }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "nav-right", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(navList, { list: rightList, click: handleNavClick }) })
    ] }) })
  ] });
};
/* harmony default export */ const header = (Header);

// EXTERNAL MODULE: ../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[3].use[1]!../../node_modules/less-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!../huxy/layout/header/index.less
var layout_header = __webpack_require__(505);
...
var header_update = injectStylesIntoStyleTag_default()(layout_header/* default */.Z, header_options);




       /* harmony default export */ const huxy_layout_header = (layout_header/* default */.Z && layout_header/* default.locals */.Z.locals ? layout_header/* default.locals */.Z.locals : undefined);
...
const MemoHeader = ({ language, ...rest }) => (0,external_react_.useMemo)(() => /* @__PURE__ */ (0,jsx_runtime.jsx)(header, { ...rest }), [language]);
const FrameHeader = (props) => {
  const { navMenu, headerStyle, navMenuStyle, Link, leftList, rightList, handleNavClick, logo, title, language } = props;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("header", { className: "frame-header", style: headerStyle, children: [
    leftList?.length || rightList?.length ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
      MemoHeader,
      {
        Link,
        leftList,
        rightList,
        handleNavClick: (item, isChild) => handleNavClick(props, item, isChild),
        logo,
        title,
        language
      }
    ) : null,
    navMenu?.length ? /* @__PURE__ */ (0,jsx_runtime.jsx)(huxy_components_tree, { data: navMenu, type: "horizontal", Link, style: navMenuStyle }) : null
  ] });
};
/* harmony default export */ const huxy_layout_header_0 = (FrameHeader);

// EXTERNAL MODULE: ../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[3].use[1]!../../node_modules/less-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!../huxy/layout/footer/index.less
...
var footer_update = injectStylesIntoStyleTag_default()(footer/* default */.Z, footer_options);
       ...
       /* harmony default export */ const layout_footer = (footer/* default */.Z && footer/* default.locals */.Z.locals ? footer/* default.locals */.Z.locals : undefined);
...
/* harmony default export */ const huxy_layout_footer = (FooterWrap);
...
const Menu = (props) => {
  const { useStore, menu, MenuTop, MenuBottom, Link, inputPath, asideStyle } = props;
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("aside", { className: "frame-aside", style: asideStyle, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { ref: menuRef, style: { height: "100%" }, children: [
    ...
    MenuBottom && /* @__PURE__ */ (0,jsx_runtime.jsx)(MenuBottom, { collapsed, isSmall: width <= 1024, setCollapsed })
  ] }) });
};
/* harmony default export */ const layout_menu = (Menu);

;// CONCATENATED MODULE: ../huxy/layout/main/views.jsx


const DELAY = 380;
const useAniCls = ({ inputPath, menuAnimate = "ani-in" }) => {
  const prevPathRef = (0,external_react_.useRef)(inputPath.split("?")[0]);
  const timer = (0,external_react_.useRef)();
  const [aniCls, setAniCls] = (0,external_react_.useState)("");
  (0,external_react_.useEffect)(() => {
    const newPath = inputPath.split("?")[0];
    if (newPath !== prevPathRef.current) {
      prevPathRef.current = newPath;
      setAniCls(` ${menuAnimate}`);
...
const Views = (props) => {
  const { inputPath, contentStyle, menuAnimate, children } = props;
  const aniCls = useAniCls({ inputPath, menuAnimate });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: `page-content${aniCls}`, style: contentStyle, children });
};
/* harmony default export */ const views = (Views);

// EXTERNAL MODULE: ../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[3].use[1]!../../node_modules/less-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!../huxy/layout/main/index.less
var main = __webpack_require__(675);
...
var main_update = injectStylesIntoStyleTag_default()(main/* default */.Z, main_options);
       ...
       /* harmony default export */ const layout_main = (main/* default */.Z && main/* default.locals */.Z.locals ? main/* default.locals */.Z.locals : undefined);
...
const Main = (props) => {
  const { menu, current, MainTop, children, inputPath, contentStyle, menuAnimate } = props;
  const hasMenu = menu?.length;
  const aniCls = menuAnimate ? menuAnimate === true ? "ani-in" : menuAnimate : "";
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: `frame-container${hasMenu ? "" : " no-sidebar"}`, children: [
    hasMenu ? /* @__PURE__ */ (0,jsx_runtime.jsx)(layout_menu, { ...props }) : null,
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "frame-view", children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: "page-container", children: [
      ...
      aniCls ? /* @__PURE__ */ (0,jsx_runtime.jsx)(views, { inputPath, contentStyle, menuAnimate: aniCls, children }) : /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "page-content", style: contentStyle, children })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("footer", { className: "frame-footer", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(huxy_layout_footer, { ...props }) })
  ] });
};
/* harmony default export */ const huxy_layout_main = (Main);

// EXTERNAL MODULE: ../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[3].use[1]!../../node_modules/less-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!../huxy/layout/frame/index.less
var layout_frame = __webpack_require__(91);
...
var frame_update = injectStylesIntoStyleTag_default()(layout_frame/* default */.Z, frame_options);
       ...
       /* harmony default export */ const huxy_layout_frame = (layout_frame/* default */.Z && layout_frame/* default.locals */.Z.locals ? layout_frame/* default.locals */.Z.locals : undefined);
...
const Frame = (props) => {
  const { useStore, vertical, horizontal, menu, leftList, rightList } = props;
  const { width } = use_useWinResize();
  ...
  const isSide = sideMenu?.length;
  const isNav = navMenu?.length;
  const isCompose = isNav && isSide;
  const menuCls = isCompose ? "compose" : isNav ? "horizontal" : collapsed ? "collapsed" : "";
  const composeCollapsedCls = isCompose && collapsed ? "composeCollapsed" : "";
  const noHeaderCls = leftList?.length || rightList?.length ? "" : "no-header";
  const classes = ["frame", menuCls, composeCollapsedCls, noHeaderCls].filter(Boolean).join(" ");
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: classes, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(huxy_layout_header_0, { ...props, navMenu }),
...
/* harmony default export */ const huxy_layout_frame_0 = (Frame);
