...
`,""]);const s=l},935:e=>{e.exports=function(t){var r=[];return r.toString=function(){return this.map(function(o){var n="",i=typeof o[5]<"u";return o[4]&&(n+="@supports (".concat(o[4],") {")),o[2]&&(n+="@media ".concat(o[2]," {")),i&&(n+="@layer".concat(o[5].length>0?" ".concat(o[5]):""," {")),n+=t(o),i&&(n+="}"),o[2]&&(n+="}"),o[4]&&(n+="}"),n}).join("")},r.i=function(o,n,i,l,s){typeof o=="string"&&(o=[[null,o,void 0]]);var c={};if(i)for(var d=0;d<this.length;d++){var y=this[d][0];y!=null&&(c[y]=!0)}for(var f=0;f<o.length;f++){var u=[].concat(o[f]);i&&c[u[0]]||(typeof s<"u"&&(typeof u[5]>"u"||(u[1]="@layer".concat(u[5].length>0?" ".concat(u[5]):""," {").concat(u[1],"}")),u[5]=s),n&&(u[2]&&(u[1]="@media ".concat(u[2]," {").concat(u[1],"}")),u[2]=n),l&&(u[4]?(u[1]="@supports (".concat(u[4],") {").concat(u[1],"}"),u[4]=l):u[4]="".concat(l)),r.push(u))}},r}},758:e=>{e.exports=function(t){return t[1]}},197:(e,t)=>{var r=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function o(n,i,l){var s=null;if(l!==void 0&&(s=""+l),i.key!==void 0&&(s=""+i.key),"key"in i){l={};for(var c in i)c!=="key"&&(l[c]=i[c])}else l=i;return i=l.ref,{$$typeof:r,type:n,key:s,ref:i!==void 0?i:null,props:l}}t.Fragment=a,t.jsx=o,t.jsxs=o},85:(e,t,r)=>{e.exports=r(197)},591:e=>{var t=[];function r(n){for(var i=-1,l=0;l<t.length;l++)if(t[l].identifier===n){i=l;break}return i}function a(n,i){for(var l={},s=[],c=0;c<n.length;c++){var d=n[c],y=i.base?d[0]+i.base:d[0],f=l[y]||0,u="".concat(y," ").concat(f);l[y]=f+1;var g=r(u),v={css:d[1],media:d[2],sourceMap:d[3],supports:d[4],layer:d[5]};if(g!==-1)t[g].references++,t[g].updater(v);else{var m=o(v,i);i.byIndex=c,t.splice(c,0,{identifier:u,updater:m,references:1})}s.push(u)}return s}function o(n,i){var l=i.domAPI(i);l.update(n);var s=function(d){if(d){if(d.css===n.css&&d.media===n.media&&d.sourceMap===n.sourceMap&&d.supports===n.supports&&d.layer===n.layer)return;l.update(n=d)}else l.remove()};return s}e.exports=function(n,i){i=i||{},n=n||[];var l=a(n,i);return function(c){c=c||[];for(var d=0;d<l.length;d++){var y=l[d],f=r(y);t[f].references--}for(var u=a(c,i),g=0;g<l.length;g++){var v=l[g],m=r(v);t[m].references===0&&(t[m].updater(),t.splice(m,1))}l=u}}},128:e=>{var t={};function r(o){if(typeof t[o]>"u"){var n=document.querySelector(o);if(window.HTMLIFrameElement&&n instanceof window.HTMLIFrameElement)try{n=n.contentDocument.head}catch{n=null}t[o]=n}return t[o]}function a(o,n){var i=r(o);if(!i)throw new Error("Couldn't find a style target. This probably means that the value for the 'insert' parameter is invalid.");i.appendChild(n)}e.exports=a},51:e=>{function t(r){var a=document.createElement("style");return r.setAttributes(a,r.attributes),r.insert(a,r.options),a}e.exports=t},855:(e,t,r)=>{function a(o){var n=r.nc;n&&o.setAttribute("nonce",n)}e.exports=a},740:e=>{function t(o,n,i){var l="";i.supports&&(l+="@supports (".concat(i.supports,") {")),i.media&&(l+="@media ".concat(i.media," {"));var s=typeof i.layer<"u";s&&(l+="@layer".concat(i.layer.length>0?" ".concat(i.layer):""," {")),l+=i.css,s&&(l+="}"),i.media&&(l+="}"),i.supports&&(l+="}");var c=i.sourceMap;c&&typeof btoa<"u"&&(l+=`
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(c))))," */")),n.styleTagTransform(l,o,n.options)}function r(o){if(o.parentNode===null)return!1;o.parentNode.removeChild(o)}function a(o){if(typeof document>"u")return{update:function(){},remove:function(){}};var n=o.insertStyleElement(o);return{update:function(l){t(n,o,l)},remove:function(){r(n)}}}e.exports=a},656:e=>{function t(r,a){if(a.styleSheet)a.styleSheet.cssText=r;else{for(;a.firstChild;)a.removeChild(a.firstChild);a.appendChild(document.createTextNode(r))}}e.exports=t}},oe={};function x(e){var t=oe[e];if(t!==void 0)return t.exports;var r=oe[e]={id:e,exports:{}};return _e[e](r,r.exports,x),r.exports}x.n=e=>{var t=e&&e.__esModule?()=>e.default:()=>e;return x.d(t,{a:t}),t},x.d=(e,t)=>{for(var r in t)x.o(t,r)&&!x.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},x.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),x.nc=void 0;var ae={};x.d(ae,{A:()=>er});var h=x(85);const we=()=>{const e={};return{on:(o,n)=>{e[o]||(e[o]=[]),e[o].indexOf(n)===-1&&e[o].push(n)},emit:(o,n)=>{e[o]&&e[o].map(i=>i(n))},off:(o,n=null)=>{if(e[o]){if(typeof n!="function")return delete e[o];const i=e[o].indexOf(n);i>-1&&(e[o].splice(i,1),e[o].length||delete e[o])}}}},J=we,Ce=J(),Ee=e=>{const{on:t,emit:r,off:a}=Ce;return{on:o=>t(e,o),emit:o=>r(e,o),off:o=>a(e,o)}},ne=Ee,ze=e=>Object.prototype.toString.call(e).slice(8,-1).toLowerCase(),Q=ze,Ae=e=>Q(e)==="object",E=Ae,Pe=e=>Q(e)==="array",L=Pe,je=e=>e?.$$typeof&&typeof e.$$typeof=="symbol"&&e.$$typeof.description?.indexOf("react.")===0,Se=je,We=e=>e?.__v_isVNode,Me=We,Ie=(e,t)=>Object.prototype.hasOwnProperty.call(e??{},t),Z=Ie,ie=e=>{if(!L(e)&&!E(e))return e;const t=L(e)?[]:{};for(const r in e)if(Z(e,r)){const a=e[r];t[r]=Se(a)||Me(a)||typeof a!="object"?a:a!==e?ie(a):"cyclic"}else Object.setPrototypeOf(t,{[r]:e[r]});return t},q=ie,le=e=>{const t={};for(let r in e)Z(e,r)||(t[r]=e[r]);return t},Le=(e,t)=>{if(!E(e))return t;if(!E(t))return e;const r={...le(e),...le(t)},a={...e,...t};return Object.keys(r).map(o=>{Object.setPrototypeOf(a,{[o]:r[o]})}),a},Be=Le,Oe=(e=J())=>{const{on:t,emit:r,off:a}=e,o={};return{getState:c=>q(o[c]),setState:(c,d=!1)=>{if(typeof c=="function"&&(c=c(q(o))),!E(c))throw TypeError("\u5FC5\u987B\u4F20\u5165object\u5BF9\u8C61\uFF01");const y=q(c);Object.keys(y).map(f=>{const u=o[f],g=y[f],v=E(g)&&E(u)?Be(u,g):g;!d&&r(f,v),o[f]=v})},subscribe:(c,d)=>(t(c,d),()=>a(c,d)),unsubscribe:a,clean:c=>{typeof c=="string"?o[c]=void 0:Array.isArray(c)?c.map(d=>o[d]=void 0):Object.keys(o).map(d=>o[d]=void 0)}}},ee=Oe,Te=(e=ee())=>(t,r)=>{const{getState:a,setState:o,subscribe:n,unsubscribe:i,clean:l}=e;return r!==void 0&&o({[t]:r},!0),{getState:()=>a(t),setState:(s,c)=>o({[t]:s},c),subscribe:s=>n(t,s),unsubscribe:()=>i(t),clean:()=>l(t)}},he=Te,He=ee(),Re=he(He),De=Re;var Ne=e=>{var t={};return x.d(t,e),t},rr=e=>()=>e;const p=Ne({useCallback:()=>I.useCallback,useEffect:()=>I.useEffect,useMemo:()=>I.useMemo,useRef:()=>I.useRef,useState:()=>I.useState}),Ue=e=>(t,r)=>{const[a,o]=(0,p.useState)(()=>{const s=e?.getState(t);return s!==void 0?s:(r!==void 0&&e?.setState({[t]:r},!0),r)}),n=(0,p.useCallback)(s=>e?.setState({[t]:typeof s=="function"?s(e?.getState(t)):s}),[]),i=(0,p.useCallback)(s=>e?.subscribe(t,s),[]),l=(0,p.useCallback)((s=s)=>e?.clean(s),[]);return(0,p.useEffect)(()=>{e?.subscribe(t,s=>o(s))},[]),[a,n,i,l]},Fe=Ue,or=ne("push-emitter"),ar=ne("replace-emitter"),nr=De("route-store"),$e=J(),se=ee($e),ir=he(se),ce=Fe(se),Ke=()=>![typeof window,typeof document].includes("undefined"),Xe=Ke,Ve=e=>Q(e).indexOf("element")>-1,Ye=Ve,Ge=(e=null)=>Xe()?Ye(e)?{width:e.clientWidth,height:e.clientHeight}:{width:window.innerWidth??document.documentElement.clientWidth,height:window.innerHeight??document.documentElement.clientHeight}:{width:0,height:0},ue=Ge,Je=(e=null)=>{const t=(0,p.useRef)(e);return()=>t},te=Je,Qe=(e={})=>{const t=te(0)(),[r,a]=(0,p.useState)(e),o=(0,p.useCallback)(n=>{cancelAnimationFrame(t.current),t.current=requestAnimationFrame(()=>a(n))},[]);return(0,p.useEffect)(()=>()=>cancelAnimationFrame(t.current),[]),[r,o]},Ze=Qe,qe=()=>{const[e,t]=Ze(ue());return(0,p.useEffect)(()=>{const r=()=>t(ue());return window.addEventListener("resize",r,!1),()=>window.removeEventListener("resize",r,!1)},[]),e},de=qe,et=(e,t,r="id",a="children")=>{if(!L(e))return null;const o=n=>{for(let i=0,l=n.length;i<l;i++){const s=n[i];if(s[r]===t)return[s];if(L(s[a])){const c=o(s[a]);if(c)return[s].concat(c)}}};return o(e)},tt=et,rt=e=>++e,ot=()=>{const[,e]=(0,p.useState)(0);return(0,p.useCallback)(()=>e(rt),[])},at=ot,nt=e=>L(e)&&!!e.length,it=nt,lt=({to:e,preventDefault:t,stopPropagation:r,...a})=>t?(0,h.jsx)("span",{...a}):(0,h.jsx)("a",{href:e,...a}),ht=({item:e,...t})=>(0,h.jsx)("ul",{...t}),st=(e,...t)=>{const r={};return Object.keys(e).filter(Boolean).map(a=>{r[a]=o=>e[a](o,...t)}),r},fe=({data:e=[],events:t={},List:r=ht,Link:a=lt,leftIcon:o,rightIcon:n,isHorizontal:i,isCollapsed:l,level:s=0,parentOpen:c=!0})=>{const d=l&&!s,y=!i&&!l&&!c;return e.map(f=>{const{name:u,path:g,icon:v,rightIcon:m,active:k,open:N,children:U,linkProps:W}=f,G=it(U),_=f.id||`${g}${f.childSameRouteLevel??""}`,F=d?f.title??u:void 0,C=y?"hidden":"",w=v??o,b=m??n,M=w?(0,h.jsx)("div",{className:"node-left-icon",children:w===!0?(0,h.jsx)("i",{className:"default-left-icon"}):w}):null,re=u?(0,h.jsx)("div",{className:"node-text",children:(0,h.jsx)("span",{children:u})}):null;if(G){const ke=st(t,f,s),be=[C,N?"open":""].filter(Boolean).join(" ");return(0,h.jsxs)("li",{className:be,"has-children":"true",...ke,children:[(0,h.jsxs)(a,{title:F,className:`link${k?" active":""}`,to:g,preventDefault:!0,stopPropagation:!1,...W,children:[M,re,b?(0,h.jsx)("div",{className:"node-right-icon",children:b===!0?(0,h.jsx)("i",{className:"default-right-icon"}):b}):null]}),(0,h.jsx)(r,{item:f,children:fe({data:U,events:t,List:r,Link:a,leftIcon:o,rightIcon:n,isHorizontal:i,isCollapsed:l,level:s+1,parentOpen:!!N})})]},_)}return(0,h.jsx)("li",{className:C,children:(0,h.jsxs)(a,{title:F,className:`link${k?" active":""}`,to:g,...W,children:[M,re]})},_)})},ct=fe,xe=e=>{const{children:t,open:r}=e;let a=0;if(r&&t?.length){a=t.length;let o=0;return t.map(n=>o+=xe(n)),a+o}return a},ut=({item:e,style:t,...r})=>(0,h.jsx)("ul",{style:{...t,"--count":xe(e)},...r}),dt=ut;var ft=x(591),B=x.n(ft),xt=x(740),O=x.n(xt),pt=x(128),T=x.n(pt),yt=x(855),H=x.n(yt),gt=x(51),R=x.n(gt),vt=x(656),D=x.n(vt),$=x(133),z={};z.styleTagTransform=D(),z.setAttributes=H(),z.insert=T().bind(null,"head"),z.domAPI=O(),z.insertStyleElement=R();var lr=B()($.A,z);const hr=$.A&&$.A.locals?$.A.locals:void 0,mt=e=>(0,h.jsx)("ul",{...e}),kt=(e,t)=>e?dt:({item:r,...a})=>(0,h.jsx)(mt,{className:t==="right"?"left":"",...a}),bt=e=>{const{data:t=[],collapsed:r=!1,type:a="vertical",Link:o,width:n,bgColor:i,itemHeight:l,collapsedWidth:s,itemPadding:c,style:d,className:y,...f}=e,u=te()(),g=te()();(0,p.useEffect)(()=>()=>clearTimeout(u.current),[]);const v=at(),m=a==="horizontal",k=!m&&r,N={onClick:(C,w)=>{if(C.stopPropagation(),!m&&!k){const b=tt(t,w.path,"path"),M=b[b.length-1];M.open=!M.open,v()}},onMouseEnter:(C,w,b)=>{k&&!b&&(clearTimeout(u.current),g.current.style.width="var(--maxWidth)")},onMouseLeave:(C,w,b)=>{k&&!b&&(u.current=setTimeout(()=>g.current.style.width="",200))}},U=(m?["huxy-horizontal-tree",y]:["huxy-tree",y,k?"collapsed":""]).filter(Boolean).join(" "),{float:W,...G}=f?.style??{},_={"--bgColor":i,"--itemHeight":l,"--nodeListWidth":n,...G};m?(_["--itemPadding"]=c,_["--nodeFloat"]=W):(_["--width"]=n,_["--collapsedWidth"]=s);const F=kt(!m&&!k,W);return(0,h.jsx)("div",{ref:g,className:U,style:_,...f,children:(0,h.jsx)("div",{className:"huxy-tree-track",children:(0,h.jsx)("ul",{className:"huxy-tree-root",children:ct({data:t,events:N,List:F,Link:o,leftIcon:!0,rightIcon:!0,isHorizontal:m,isCollapsed:k})})})})},pe=bt,_t=e=>Z(e,"current"),wt=_t,Ct=(e,t,r="click")=>{(0,p.useEffect)(()=>{const a=n=>{const i=typeof e=="function"?e():e,l=wt(i)?i.current:i;l?.contains&&!l.contains(n.target)&&t(n)},o=typeof r=="string"?[r]:r;return o.map(n=>{document.addEventListener(n,a,!1)}),()=>{o.map(n=>{document.removeEventListener(n,a,!1)})}},[e])},ye=Ct,Et=e=>/^https?:\/\/[^\s/?.#]+\.[^\s]+/.test(e),zt=Et,At=e=>new Promise((t,r)=>{const a=new FileReader;a.readAsDataURL(e),a.addEventListener("load",()=>t(a.result)),a.addEventListener("error",o=>r(o))}),Pt=At,jt=async e=>{if(!zt(e))return e;const r=await(await fetch(decodeURIComponent(e))).blob();return await Pt(r)},St=jt,Wt=e=>{const[t,r]=(0,p.useState)(e);return(0,p.useEffect)(()=>{(async o=>{const n=await St(o);r(n)})(e)},[e]),t},Mt=Wt,It=({src:e,...t})=>{const r=Mt(e);return(0,h.jsx)("img",{...t,src:r})},Lt=It,ge=({Ricon:e,open:t})=>e===!0?(0,h.jsx)("i",{className:`huxy-header-angle-${t?"top":"bt"}`}):(0,h.jsx)(e,{status:t}),Bt=({img:e,name:t,icon:r,Ricon:a,open:o})=>e?(0,h.jsxs)("div",{className:"avatar",children:[(0,h.jsx)("div",{className:"img",children:(0,h.jsx)(Lt,{src:e,width:"1",height:"1",crossOrigin:"anonymous",alt:"avatar"})}),t?(0,h.jsx)("span",{className:"txt",children:t}):null,a?(0,h.jsx)("span",{className:"node-icon",children:(0,h.jsx)(ge,{Ricon:a,open:o})}):null]}):(0,h.jsxs)(h.Fragment,{children:[r?(0,h.jsx)("span",{className:"node-icon",children:r}):null,t?(0,h.jsx)("span",{className:"txt",children:t}):null,a?(0,h.jsx)("span",{className:"node-icon",children:(0,h.jsx)(ge,{Ricon:a,open:o})}):null]}),ve=({item:e,open:t})=>{const{Custom:r,img:a,name:o,icon:n,Ricon:i,active:l}=e;return typeof r=="function"?(0,h.jsx)(r,{item:e,className:"link"}):(0,h.jsx)("span",{className:`link${l?" active":""}`,title:e.title||o,children:(0,h.jsx)(Bt,{img:a,name:o,icon:n,Ricon:i,open:t})})},Ot=({item:e,click:t})=>{const r=(0,p.useRef)(),[a,o]=(0,p.useState)(!1),n=(0,p.useCallback)(()=>r,[r.current]);ye(n,u=>a&&o(!1));const{arrowDir:i,ChildRender:l,children:s,smShow:c}=e,d=s?.length,y=(u,g,v=null)=>{v===!1&&o(m=>!m),v&&(u.stopPropagation(),o(!1)),t(g,v)},f=c?"sm-show":"";return d||l?(0,h.jsxs)("li",{ref:r,className:`${f} ${a?"open":""}`,onClick:u=>y(u,e,!1),children:[(0,h.jsx)(ve,{item:e,open:a}),(0,h.jsx)("ul",{className:`huxy-header-arrow-${i||"rt"}`,children:d?s.map((u,g)=>(0,h.jsx)("li",{className:u.divider?"divider":"",children:(0,h.jsxs)("span",{onClick:v=>y(v,u,!0),className:`link${u.active?" active":""}`,children:[u.icon?(0,h.jsx)("span",{className:"node-icon",children:u.icon}):null,(0,h.jsx)("span",{className:"drop-label",children:u.name})]})},`subItem-${g}-${u.key||u.name}`)):(0,h.jsx)("li",{children:(0,h.jsx)(l,{item:e,close:()=>o(!1)})})})]}):(0,h.jsx)("li",{onClick:u=>y(u,e),className:f,children:(0,h.jsx)(ve,{item:e,open:a})})},Tt=({list:e,click:t})=>(0,h.jsx)("ul",{children:e.map((r,a)=>(0,h.jsx)(Ot,{click:t,item:r},`navItem-${a}-${r.key||r.name}`))}),me=Tt,Ht=e=>{const{leftList:t,rightList:r,handleNavClick:a,logo:o,title:n,Link:i}=e;return(0,h.jsxs)("div",{className:"header",children:[(0,h.jsxs)(i,{className:"banner",to:"/",children:[o?(0,h.jsx)("div",{className:"logo",children:(0,h.jsx)("img",{width:"1",height:"1",src:o,alt:"logo"})}):null,(0,h.jsx)("div",{className:"title",children:n??"Dashboard"})]}),(0,h.jsx)("div",{className:"nav",children:(0,h.jsxs)("div",{className:"nav-wrap",children:[(0,h.jsx)("div",{className:"nav-left",children:(0,h.jsx)(me,{list:t,click:a})}),(0,h.jsx)("div",{className:"nav-right",children:(0,h.jsx)(me,{list:r,click:a})})]})})]})},Rt=Ht;var K=x(754),A={};A.styleTagTransform=D(),A.setAttributes=H(),A.insert=T().bind(null,"head"),A.domAPI=O(),A.insertStyleElement=R();var sr=B()(K.A,A);const cr=K.A&&K.A.locals?K.A.locals:void 0,Dt=({language:e,...t})=>(0,p.useMemo)(()=>(0,h.jsx)(Rt,{...t}),[e]),Nt=e=>{const{navMenu:t,headerStyle:r,navMenuStyle:a,Link:o,leftList:n,rightList:i,handleNavClick:l,logo:s,title:c,language:d}=e;return(0,h.jsxs)("header",{className:"frame-header",style:r,children:[n?.length||i?.length?(0,h.jsx)(Dt,{Link:o,leftList:n,rightList:i,handleNavClick:(y,f)=>l(e,y,f),logo:s,title:c,language:d}):null,t?.length?(0,h.jsx)(pe,{data:t,type:"horizontal",Link:o,style:a}):null]})},Ut=Nt;var X=x(144),P={};P.styleTagTransform=D(),P.setAttributes=H(),P.insert=T().bind(null,"head"),P.domAPI=O(),P.insertStyleElement=R();var ur=B()(X.A,P);const dr=X.A&&X.A.locals?X.A.locals:void 0,Ft=({Footer:e})=>(0,h.jsx)("div",{className:"footer",children:e?(0,h.jsx)(e,{}):"copyright \xA9 2020-2022"}),$t=Ft,Kt=e=>{const{menu:t,MenuTop:r,MenuBottom:a,Link:o,inputPath:n,asideStyle:i}=e,[l,s]=ce("huxy-collapse"),{width:c}=de(),d=(0,p.useRef)(),y=(0,p.useCallback)(()=>d,[d.current]);return ye(y,f=>{c<=1024&&l&&s(!1)}),(0,p.useEffect)(()=>{c<=1024&&l&&s(!1)},[n]),(0,h.jsx)("aside",{className:"frame-aside",style:i,children:(0,h.jsxs)("div",{ref:d,style:{height:"100%"},children:[r&&(0,h.jsx)(r,{...e}),(0,h.jsx)(pe,{data:t,collapsed:l&&c>1024,Link:o}),a&&(0,h.jsx)(a,{collapsed:l,isSmall:c<=1024,setCollapsed:s})]})})},Xt=Kt,Vt=380,Yt=({inputPath:e,menuAnimate:t="ani-in"})=>{const r=(0,p.useRef)(e.split("?")[0]),a=(0,p.useRef)(),[o,n]=(0,p.useState)("");return(0,p.useEffect)(()=>{const i=e.split("?")[0];return i!==r.current&&(r.current=i,n(` ${t}`),a.current=setTimeout(()=>{n("")},Vt)),()=>{clearTimeout(a.current),n("")}},[e]),o},Gt=e=>{const{inputPath:t,contentStyle:r,menuAnimate:a,children:o}=e,n=Yt({inputPath:t,menuAnimate:a});return(0,h.jsx)("div",{className:`page-content${n}`,style:r,children:o})},Jt=Gt;var V=x(658),j={};j.styleTagTransform=D(),j.setAttributes=H(),j.insert=T().bind(null,"head"),j.domAPI=O(),j.insertStyleElement=R();var fr=B()(V.A,j);const xr=V.A&&V.A.locals?V.A.locals:void 0,Qt=e=>{const{menu:t,current:r,MainTop:a,children:o,inputPath:n,contentStyle:i,menuAnimate:l}=e,s=t?.length,c=l?l===!0?"ani-in":l:"";return(0,h.jsxs)("div",{className:`frame-container${s?"":" no-sidebar"}`,children:[s?(0,h.jsx)(Xt,{...e}):null,(0,h.jsx)("div",{className:"frame-view",children:(0,h.jsxs)("div",{className:"page-container",children:[a&&(0,h.jsx)(a,{current:r}),c?(0,h.jsx)(Jt,{inputPath:n,contentStyle:i,menuAnimate:c,children:o}):(0,h.jsx)("div",{className:"page-content",style:i,children:o})]})}),(0,h.jsx)("footer",{className:"frame-footer",children:(0,h.jsx)($t,{...e})})]})},Zt=Qt;var Y=x(524),S={};S.styleTagTransform=D(),S.setAttributes=H(),S.insert=T().bind(null,"head"),S.domAPI=O(),S.insertStyleElement=R();var pr=B()(Y.A,S);const yr=Y.A&&Y.A.locals?Y.A.locals:void 0,qt=e=>{const{vertical:t,horizontal:r,menu:a,leftList:o,rightList:n}=e,{width:i}=de(),[l]=ce("huxy-collapse"),s=i<=1024,c=s?a:t,d=s?[]:r,y=c?.length,f=d?.length,u=f&&y,g=u?"compose":f?"horizontal":l?"collapsed":"",v=u&&l?"composeCollapsed":"",m=o?.length||n?.length?"":"no-header",k=["frame",g,v,m].filter(Boolean).join(" ");return(0,h.jsxs)("div",{className:k,children:[(0,h.jsx)(Ut,{...e,navMenu:d}),(0,h.jsx)("main",{className:"frame-main",children:(0,h.jsx)(Zt,{...e,menu:c})})]})},er=qt;var tr=ae.A;export{tr as default};
