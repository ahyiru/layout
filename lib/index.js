import*as I from"react";var be={133:(e,t,r)=>{r.d(t,{A:()=>s});var a=r(758),o=r.n(a),n=r(935),i=r.n(n),l=i()(o());l.push([e.id,`.node-right-icon-close {
  height: 100%;
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(c))))," */")),n.styleTagTransform(l,o,n.options)}function r(o){if(o.parentNode===null)return!1;o.parentNode.removeChild(o)}function a(o){if(typeof document>"u")return{update:function(){},remove:function(){}};var n=o.insertStyleElement(o);return{update:function(l){t(n,o,l)},remove:function(){r(n)}}}e.exports=a},656:e=>{function t(r,a){if(a.styleSheet)a.styleSheet.cssText=r;else{for(;a.firstChild;)a.removeChild(a.firstChild);a.appendChild(document.createTextNode(r))}}e.exports=t}},re={};function x(e){var t=re[e];if(t!==void 0)return t.exports;var r=re[e]={id:e,exports:{}};return be[e](r,r.exports,x),r.exports}x.n=e=>{var t=e&&e.__esModule?()=>e.default:()=>e;return x.d(t,{a:t}),t},x.d=(e,t)=>{for(var r in t)x.o(t,r)&&!x.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},x.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),x.nc=void 0;var oe={};x.d(oe,{A:()=>Zt});var h=x(85);const _e=()=>{const e={};return{on:(o,n)=>{e[o]||(e[o]=[]),e[o].indexOf(n)===-1&&e[o].push(n)},emit:(o,n)=>{e[o]&&e[o].map(i=>i(n))},off:(o,n=null)=>{if(e[o]){if(typeof n!="function")return delete e[o];const i=e[o].indexOf(n);i>-1&&(e[o].splice(i,1),e[o].length||delete e[o])}}}},J=_e,we=J(),Ce=e=>{const{on:t,emit:r,off:a}=we;return{on:o=>t(e,o),emit:o=>r(e,o),off:o=>a(e,o)}},ae=Ce,Ee=e=>Object.prototype.toString.call(e).slice(8,-1).toLowerCase(),Q=Ee,ze=e=>Q(e)==="object",E=ze,Ae=e=>Q(e)==="array",L=Ae,Pe=e=>e?.$$typeof&&typeof e.$$typeof=="symbol"&&e.$$typeof.description?.indexOf("react.")===0,je=Pe,Se=e=>e?.__v_isVNode,We=Se,Me=(e,t)=>Object.prototype.hasOwnProperty.call(e??{},t),Z=Me,ne=e=>{if(!L(e)&&!E(e))return e;const t=L(e)?[]:{};for(const r in e)if(Z(e,r)){const a=e[r];t[r]=je(a)||We(a)||typeof a!="object"?a:a!==e?ne(a):"cyclic"}else Object.setPrototypeOf(t,{[r]:e[r]});return t},q=ne,ie=e=>{const t={};for(let r in e)Z(e,r)||(t[r]=e[r]);return t},Ie=(e,t)=>{if(!E(e))return t;if(!E(t))return e;const r={...ie(e),...ie(t)},a={...e,...t};return Object.keys(r).map(o=>{Object.setPrototypeOf(a,{[o]:r[o]})}),a},Le=Ie,Be=(e=J())=>{const{on:t,emit:r,off:a}=e,o={};return{getState:c=>q(o[c]),setState:(c,u=!1)=>{if(typeof c=="function"&&(c=c(q(o))),!E(c))throw TypeError("\u5FC5\u987B\u4F20\u5165object\u5BF9\u8C61\uFF01");const g=q(c);Object.keys(g).map(f=>{const d=o[f],p=g[f],m=E(p)&&E(d)?Le(d,p):p;!u&&r(f,m),o[f]=m})},subscribe:(c,u)=>(t(c,u),()=>a(c,u)),unsubscribe:a,clean:c=>{typeof c=="string"?o[c]=void 0:Array.isArray(c)?c.map(u=>o[u]=void 0):Object.keys(o).map(u=>o[u]=void 0)}}},ee=Be,Oe=(e=ee())=>(t,r)=>{const{getState:a,setState:o,subscribe:n,unsubscribe:i,clean:l}=e;return r!==void 0&&o({[t]:r},!0),{getState:()=>a(t),setState:(s,c)=>o({[t]:s},c),subscribe:s=>n(t,s),unsubscribe:()=>i(t),clean:()=>l(t)}},le=Oe,Te=ee(),He=le(Te),Re=He;var De=e=>{var t={};return x.d(t,e),t},er=e=>()=>e;const y=De({useCallback:()=>I.useCallback,useEffect:()=>I.useEffect,useMemo:()=>I.useMemo,useRef:()=>I.useRef,useState:()=>I.useState}),Ne=e=>(t,r)=>{const[a,o]=(0,y.useState)(()=>{const s=e?.getState(t);return s!==void 0?s:(r!==void 0&&e?.setState({[t]:r},!0),r)}),n=(0,y.useCallback)(s=>e?.setState({[t]:typeof s=="function"?s(e?.getState(t)):s}),[]),i=(0,y.useCallback)(s=>e?.subscribe(t,s),[]),l=(0,y.useCallback)((s=s)=>e?.clean(s),[]);return(0,y.useEffect)(()=>{e?.subscribe(t,s=>o(s))},[]),[a,n,i,l]},Ue=Ne,tr=ae("push-emitter"),rr=ae("replace-emitter"),or=Re("route-store"),Fe=J(),he=ee(Fe),ar=le(he),se=Ue(he),$e=()=>![typeof window,typeof document].includes("undefined"),Ke=$e,Xe=e=>Q(e).indexOf("element")>-1,Ve=Xe,Ye=(e=null)=>Ke()?Ve(e)?{width:e.clientWidth,height:e.clientHeight}:{width:window.innerWidth??document.documentElement.clientWidth,height:window.innerHeight??document.documentElement.clientHeight}:{width:0,height:0},ce=Ye,Ge=(e={})=>{const t=(0,y.useRef)(0),[r,a]=(0,y.useState)(e),o=(0,y.useCallback)(n=>{cancelAnimationFrame(t.current),t.current=requestAnimationFrame(()=>a(n))},[]);return(0,y.useEffect)(()=>()=>cancelAnimationFrame(t.current),[]),[r,o]},Je=Ge,Qe=()=>{const[e,t]=Je(ce());return(0,y.useEffect)(()=>{const r=()=>t(ce());return window.addEventListener("resize",r,!1),()=>window.removeEventListener("resize",r,!1)},[]),e},ue=Qe,Ze=(e,t,r="id",a="children")=>{if(!L(e))return null;const o=n=>{for(let i=0,l=n.length;i<l;i++){const s=n[i];if(s[r]===t)return[s];if(L(s[a])){const c=o(s[a]);if(c)return[s].concat(c)}}};return o(e)},qe=Ze,et=e=>++e,tt=()=>{const[,e]=(0,y.useState)(0);return(0,y.useCallback)(()=>e(et),[])},rt=tt,ot=e=>L(e)&&!!e.length,at=ot,nt=({to:e,preventDefault:t,stopPropagation:r,...a})=>t?(0,h.jsx)("span",{...a}):(0,h.jsx)("a",{href:e,...a}),it=({item:e,...t})=>(0,h.jsx)("ul",{...t}),lt=(e,...t)=>{const r={};return Object.keys(e).filter(Boolean).map(a=>{r[a]=o=>e[a](o,...t)}),r},de=({data:e=[],events:t={},List:r=it,Link:a=nt,leftIcon:o,rightIcon:n,isHorizontal:i,isCollapsed:l,level:s=0,parentOpen:c=!0})=>{const u=l&&!s,g=!i&&!l&&!c;return e.map(f=>{const{name:d,path:p,icon:m,rightIcon:v,active:k,open:N,children:U,linkProps:W}=f,G=at(U),_=f.id||`${p}${f.childSameRouteLevel??""}`,F=u?f.title??d:void 0,C=g?"hidden":"",w=m??o,b=v??n,M=w?(0,h.jsx)("div",{className:"node-left-icon",children:w===!0?(0,h.jsx)("i",{className:"default-left-icon"}):w}):null,te=d?(0,h.jsx)("div",{className:"node-text",children:(0,h.jsx)("span",{children:d})}):null;if(G){const me=lt(t,f,s),ke=[C,N?"open":""].filter(Boolean).join(" ");return(0,h.jsxs)("li",{className:ke,"has-children":"true",...me,children:[(0,h.jsxs)(a,{title:F,className:`link${k?" active":""}`,to:p,preventDefault:!0,stopPropagation:!1,...W,children:[M,te,b?(0,h.jsx)("div",{className:"node-right-icon",children:b===!0?(0,h.jsx)("i",{className:"default-right-icon"}):b}):null]}),(0,h.jsx)(r,{item:f,children:de({data:U,events:t,List:r,Link:a,leftIcon:o,rightIcon:n,isHorizontal:i,isCollapsed:l,level:s+1,parentOpen:!!N})})]},_)}return(0,h.jsx)("li",{className:C,children:(0,h.jsxs)(a,{title:F,className:`link${k?" active":""}`,to:p,...W,children:[M,te]})},_)})},ht=de,fe=e=>{const{children:t,open:r}=e;let a=0;if(r&&t?.length){a=t.length;let o=0;return t.map(n=>o+=fe(n)),a+o}return a},st=({item:e,style:t,...r})=>(0,h.jsx)("ul",{style:{...t,"--count":fe(e)},...r}),ct=st;var ut=x(591),B=x.n(ut),dt=x(740),O=x.n(dt),ft=x(128),T=x.n(ft),xt=x(855),H=x.n(xt),pt=x(51),R=x.n(pt),yt=x(656),D=x.n(yt),$=x(133),z={};z.styleTagTransform=D(),z.setAttributes=H(),z.insert=T().bind(null,"head"),z.domAPI=O(),z.insertStyleElement=R();var nr=B()($.A,z);const ir=$.A&&$.A.locals?$.A.locals:void 0,gt=e=>(0,h.jsx)("ul",{...e}),vt=(e,t)=>e?ct:({item:r,...a})=>(0,h.jsx)(gt,{className:t==="right"?"left":"",...a}),mt=e=>{const{data:t=[],collapsed:r=!1,type:a="vertical",Link:o,width:n,bgColor:i,itemHeight:l,collapsedWidth:s,itemPadding:c,style:u,className:g,...f}=e,d=(0,y.useRef)(),p=(0,y.useRef)();(0,y.useEffect)(()=>()=>clearTimeout(d.current),[]);const m=rt(),v=a==="horizontal",k=!v&&r,N={onClick:(C,w)=>{if(C.stopPropagation(),!v&&!k){const b=qe(t,w.path,"path"),M=b[b.length-1];M.open=!M.open,m()}},onMouseEnter:(C,w,b)=>{k&&!b&&(clearTimeout(d.current),p.current.style.width="var(--maxWidth)")},onMouseLeave:(C,w,b)=>{k&&!b&&(d.current=setTimeout(()=>p.current.style.width="",200))}},U=(v?["huxy-horizontal-tree",g]:["huxy-tree",g,k?"collapsed":""]).filter(Boolean).join(" "),{float:W,...G}=f?.style??{},_={"--bgColor":i,"--itemHeight":l,"--nodeListWidth":n,...G};v?(_["--itemPadding"]=c,_["--nodeFloat"]=W):(_["--width"]=n,_["--collapsedWidth"]=s);const F=vt(!v&&!k,W);return(0,h.jsx)("div",{ref:p,className:U,style:_,...f,children:(0,h.jsx)("div",{className:"huxy-tree-track",children:(0,h.jsx)("ul",{className:"huxy-tree-root",children:ht({data:t,events:N,List:F,Link:o,leftIcon:!0,rightIcon:!0,isHorizontal:v,isCollapsed:k})})})})},xe=mt,kt=e=>Z(e,"current"),bt=kt,_t=(e,t,r="click")=>{(0,y.useEffect)(()=>{const a=n=>{const i=bt(e)?e.current:e;i?.contains&&!i.contains(n.target)&&t(n)},o=typeof r=="string"?[r]:r;return o.map(n=>{document.addEventListener(n,a,!1)}),()=>{o.map(n=>{document.removeEventListener(n,a,!1)})}},[e,t,r])},pe=_t,wt=e=>/^https?:\/\/[^\s/?.#]+\.[^\s]+/.test(e),Ct=wt,Et=e=>new Promise((t,r)=>{const a=new FileReader;a.readAsDataURL(e),a.addEventListener("load",()=>t(a.result)),a.addEventListener("error",o=>r(o))}),zt=Et,At=async e=>{if(!Ct(e))return e;const r=await(await fetch(decodeURIComponent(e))).blob();return await zt(r)},Pt=At,jt=e=>{const[t,r]=(0,y.useState)(e);return(0,y.useEffect)(()=>{(async o=>{const n=await Pt(o);r(n)})(e)},[e]),t},St=jt,Wt=({src:e,...t})=>{const r=St(e);return(0,h.jsx)("img",{...t,src:r})},Mt=Wt,ye=({Ricon:e,open:t})=>e===!0?(0,h.jsx)("i",{className:`huxy-header-angle-${t?"top":"bt"}`}):(0,h.jsx)(e,{status:t}),It=({img:e,name:t,icon:r,Ricon:a,open:o})=>e?(0,h.jsxs)("div",{className:"avatar",children:[(0,h.jsx)("div",{className:"img",children:(0,h.jsx)(Mt,{src:e,width:"1",height:"1",crossOrigin:"anonymous",alt:"avatar"})}),t?(0,h.jsx)("span",{className:"txt",children:t}):null,a?(0,h.jsx)("span",{className:"node-icon",children:(0,h.jsx)(ye,{Ricon:a,open:o})}):null]}):(0,h.jsxs)(h.Fragment,{children:[r?(0,h.jsx)("span",{className:"node-icon",children:r}):null,t?(0,h.jsx)("span",{className:"txt",children:t}):null,a?(0,h.jsx)("span",{className:"node-icon",children:(0,h.jsx)(ye,{Ricon:a,open:o})}):null]}),ge=({item:e,open:t})=>{const{Custom:r,img:a,name:o,icon:n,Ricon:i,active:l}=e;return typeof r=="function"?(0,h.jsx)(r,{item:e,className:"link"}):(0,h.jsx)("span",{className:`link${l?" active":""}`,title:e.title||o,children:(0,h.jsx)(It,{img:a,name:o,icon:n,Ricon:i,open:t})})},Lt=({item:e,click:t})=>{const r=(0,y.useRef)(),[a,o]=(0,y.useState)(!1);pe(r,f=>a&&o(!1));const{arrowDir:n,ChildRender:i,children:l,smShow:s}=e,c=l?.length,u=(f,d,p=null)=>{p===!1&&o(m=>!m),p&&(f.stopPropagation(),o(!1)),t(d,p)},g=s?"sm-show":"";return c||i?(0,h.jsxs)("li",{ref:r,className:`${g} ${a?"open":""}`,onClick:f=>u(f,e,!1),children:[(0,h.jsx)(ge,{item:e,open:a}),(0,h.jsx)("ul",{className:`huxy-header-arrow-${n||"rt"}`,children:c?l.map((f,d)=>(0,h.jsx)("li",{className:f.divider?"divider":"",children:(0,h.jsxs)("span",{onClick:p=>u(p,f,!0),className:`link${f.active?" active":""}`,children:[f.icon?(0,h.jsx)("span",{className:"node-icon",children:f.icon}):null,(0,h.jsx)("span",{className:"drop-label",children:f.name})]})},`subItem-${d}-${f.key||f.name}`)):(0,h.jsx)("li",{children:(0,h.jsx)(i,{item:e,close:()=>o(!1)})})})]}):(0,h.jsx)("li",{onClick:f=>u(f,e),className:g,children:(0,h.jsx)(ge,{item:e,open:a})})},Bt=({list:e,click:t})=>(0,h.jsx)("ul",{children:e.map((r,a)=>(0,h.jsx)(Lt,{click:t,item:r},`navItem-${a}-${r.key||r.name}`))}),ve=Bt,Ot=e=>{const{leftList:t,rightList:r,handleNavClick:a,logo:o,title:n,Link:i}=e;return(0,h.jsxs)("div",{className:"header",children:[(0,h.jsxs)(i,{className:"banner",to:"/",children:[o?(0,h.jsx)("div",{className:"logo",children:(0,h.jsx)("img",{width:"1",height:"1",src:o,alt:"logo"})}):null,(0,h.jsx)("div",{className:"title",children:n??"Dashboard"})]}),(0,h.jsx)("div",{className:"nav",children:(0,h.jsxs)("div",{className:"nav-wrap",children:[(0,h.jsx)("div",{className:"nav-left",children:(0,h.jsx)(ve,{list:t,click:a})}),(0,h.jsx)("div",{className:"nav-right",children:(0,h.jsx)(ve,{list:r,click:a})})]})})]})},Tt=Ot;var K=x(754),A={};A.styleTagTransform=D(),A.setAttributes=H(),A.insert=T().bind(null,"head"),A.domAPI=O(),A.insertStyleElement=R();var lr=B()(K.A,A);const hr=K.A&&K.A.locals?K.A.locals:void 0,Ht=({language:e,...t})=>(0,y.useMemo)(()=>(0,h.jsx)(Tt,{...t}),[e]),Rt=e=>{const{navMenu:t,headerStyle:r,navMenuStyle:a,Link:o,leftList:n,rightList:i,handleNavClick:l,logo:s,title:c,language:u}=e;return(0,h.jsxs)("header",{className:"frame-header",style:r,children:[n?.length||i?.length?(0,h.jsx)(Ht,{Link:o,leftList:n,rightList:i,handleNavClick:(g,f)=>l(e,g,f),logo:s,title:c,language:u}):null,t?.length?(0,h.jsx)(xe,{data:t,type:"horizontal",Link:o,style:a}):null]})},Dt=Rt;var X=x(144),P={};P.styleTagTransform=D(),P.setAttributes=H(),P.insert=T().bind(null,"head"),P.domAPI=O(),P.insertStyleElement=R();var sr=B()(X.A,P);const cr=X.A&&X.A.locals?X.A.locals:void 0,Nt=({Footer:e})=>(0,h.jsx)("div",{className:"footer",children:e?(0,h.jsx)(e,{}):"copyright \xA9 2020-2022"}),Ut=Nt,Ft=e=>{const{menu:t,MenuTop:r,MenuBottom:a,Link:o,inputPath:n,asideStyle:i}=e,[l,s]=se("huxy-collapse"),{width:c}=ue(),u=(0,y.useRef)();return pe(u,g=>{c<=1024&&l&&s(!1)}),(0,y.useEffect)(()=>{c<=1024&&l&&s(!1)},[n]),(0,h.jsx)("aside",{className:"frame-aside",style:i,children:(0,h.jsxs)("div",{ref:u,style:{height:"100%"},children:[r&&(0,h.jsx)(r,{...e}),(0,h.jsx)(xe,{data:t,collapsed:l&&c>1024,Link:o}),a&&(0,h.jsx)(a,{collapsed:l,isSmall:c<=1024,setCollapsed:s})]})})},$t=Ft,Kt=380,Xt=({inputPath:e,menuAnimate:t="ani-in"})=>{const r=(0,y.useRef)(e.split("?")[0]),a=(0,y.useRef)(),[o,n]=(0,y.useState)("");return(0,y.useEffect)(()=>{const i=e.split("?")[0];return i!==r.current&&(r.current=i,n(` ${t}`),a.current=setTimeout(()=>{n("")},Kt)),()=>{clearTimeout(a.current),n("")}},[e]),o},Vt=e=>{const{inputPath:t,contentStyle:r,menuAnimate:a,children:o}=e,n=Xt({inputPath:t,menuAnimate:a});return(0,h.jsx)("div",{className:`page-content${n}`,style:r,children:o})},Yt=Vt;var V=x(658),j={};j.styleTagTransform=D(),j.setAttributes=H(),j.insert=T().bind(null,"head"),j.domAPI=O(),j.insertStyleElement=R();var ur=B()(V.A,j);const dr=V.A&&V.A.locals?V.A.locals:void 0,Gt=e=>{const{menu:t,current:r,MainTop:a,children:o,inputPath:n,contentStyle:i,menuAnimate:l}=e,s=t?.length,c=l?l===!0?"ani-in":l:"";return(0,h.jsxs)("div",{className:`frame-container${s?"":" no-sidebar"}`,children:[s?(0,h.jsx)($t,{...e}):null,(0,h.jsx)("div",{className:"frame-view",children:(0,h.jsxs)("div",{className:"page-container",children:[a&&(0,h.jsx)(a,{current:r}),c?(0,h.jsx)(Yt,{inputPath:n,contentStyle:i,menuAnimate:c,children:o}):(0,h.jsx)("div",{className:"page-content",style:i,children:o})]})}),(0,h.jsx)("footer",{className:"frame-footer",children:(0,h.jsx)(Ut,{...e})})]})},Jt=Gt;var Y=x(524),S={};S.styleTagTransform=D(),S.setAttributes=H(),S.insert=T().bind(null,"head"),S.domAPI=O(),S.insertStyleElement=R();var fr=B()(Y.A,S);const xr=Y.A&&Y.A.locals?Y.A.locals:void 0,Qt=e=>{const{vertical:t,horizontal:r,menu:a,leftList:o,rightList:n}=e,{width:i}=ue(),[l]=se("huxy-collapse"),s=i<=1024,c=s?a:t,u=s?[]:r,g=c?.length,f=u?.length,d=f&&g,p=d?"compose":f?"horizontal":l?"collapsed":"",m=d&&l?"composeCollapsed":"",v=o?.length||n?.length?"":"no-header",k=["frame",p,m,v].filter(Boolean).join(" ");return(0,h.jsxs)("div",{className:k,children:[(0,h.jsx)(Dt,{...e,navMenu:u}),(0,h.jsx)("main",{className:"frame-main",children:(0,h.jsx)(Jt,{...e,menu:c})})]})},Zt=Qt;var qt=oe.A;export{qt as default};
